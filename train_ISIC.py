...
parser.add_argument('--imgs_train_path', type=str,
                    default='datasets/isic2017/training_data/ISIC-2017_Training_Data',
                    help='imgs train data path.')
parser.add_argument('--labels_train_path', type=str,
                    default='datasets/isic2017/training_ground_truth/ISIC-2017_Training_Part1_GroundTruth',
                    help='labels train data path.')
parser.add_argument('--csv_dir_train', type=str,
                    default='datasets/isic2017/training_data/ISIC-2017_Training_Data/ISIC-2017_Training_Data_metadata_modified.csv',
                    help='labels train data path.')
parser.add_argument('--imgs_val_path', type=str,
                    default='datasets/isic2017/validation_data/ISIC-2017_Validation_Data',
                    help='imgs val data path.')
parser.add_argument('--labels_val_path', type=str,
                    default='datasets/isic2017/validation_ground_truth/ISIC-2017_Validation_Part1_GroundTruth',
                    help='labels val data path.')
parser.add_argument('--csv_dir_val', type=str,
                    default='datasets/isic2017/validation_data/ISIC-2017_Validation_Data/ISIC-2017_Validation_Data_metadata_modified.csv',
                    help='labels val data path.')
